...
class ListCharacterViewModel @Inject constructor(
    ...
    private val _list = MutableStateFlow<
            ResourceState<CharacterModelResponse>>(ResourceState.Loading())
    ...
    private suspend fun safeFetch() {
        try {
            ...
            when(t) {
                is IOException -> {
                    _list.value= ResourceState.Error("Erro de conexão com a internet")
                }
    ...
    private fun handleResponse(response: Response<CharacterModelResponse>):
